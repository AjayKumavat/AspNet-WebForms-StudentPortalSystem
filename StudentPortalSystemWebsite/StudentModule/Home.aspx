<%@ Page Title="" Language="C#" MasterPageFile="~/StudentModule/Student.Master" AutoEventWireup="true" CodeBehind="Home.aspx.cs" Inherits="StudentPortalSystemWebsite.StudentModule.Home" %>
        ...
        <div class="admin-row">
            ...
            <!-- SQL DATA SOURCE -->
                <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:StudentPortalSystem_dbConnectionString %>" SelectCommand="SELECT * FROM [Notice] WHERE ([notice_for] = @notice_for) ORDER BY [notice_id] DESC">
                    <SelectParameters>
                        <asp:Parameter DefaultValue="Student" Name="notice_for" Type="String" />
                    </SelectParameters>
                </asp:SqlDataSource>
