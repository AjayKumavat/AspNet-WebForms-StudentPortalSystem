<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="StudentPortalSystemWebsite.StudentModule.Default" %>
    ...
    <form id="form1" runat="server">
        ...
        <div class="login-page-width">
            ...
            <div class="col span-1-of-2  login-both-panel login-image-panel login-js--wp-2">
                ...
                <img src="resources/img/Student_Standing_on_book.svg" alt="Student Login Page" />
            ...
            <div class="col span-1-of-2 login-both-panel login-form-panel">
                <div class="login-right-panel-form  login-js--wp-3">
                    ...
                    <div class="login-button-div">
                       ...
                       <!-- Register -->
                        <!-- Using anchor tag to apply the btn-ghost class, god knows why but all the asp button are of same style -->
                       <div class="login-button">
                            <a class="btn btn-ghost" href="Registration.aspx">Registration</a>
                       </div>
                    </div>
                </div>
            </div>
