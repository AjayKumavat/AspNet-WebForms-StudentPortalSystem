<%@ Page Title="" Language="C#" MasterPageFile="~/AdminModule/Admin.Master" AutoEventWireup="true" CodeBehind="AddMarks.aspx.cs" Inherits="StudentPortalSystemWebsite.AdminModule.AddMarks" %>
...
<!-- --------------------------------------------- -->
    ...
    <!-- --------------------------------------------- -->
        <!-- ALL STUDENT MARKS ENTRIES SECTION -->
<!-- --------------------------------------------- -->
    <%--<section id="NoticeEntries" class="section-notice-grid-view admin-js--notice-table">
        <div class="admin-row">
            <h2>All Added Marks Entries</h2>
        </div>

        <div class="admin-row">

            <!-- SQL DATA SOURCE -->
            <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:StudentPortalSystem_dbConnectionString %>" SelectCommand="SELECT * FROM [StudentMarks]"></asp:SqlDataSource>
            ...
            <div class="grid-view-data-table">
                ...
                <!-- GRID VIEW TABLE -->
                <asp:GridView ID="GridView2" runat="server" CssClass="enter-marks-data-table table table-striped table-bordered" AutoGenerateColumns="False" DataSourceID="SqlDataSource1">
                    <Columns>
                            ...
                            <ItemTemplate>
                                ...
                                <div>
                                    <div class="col span-3-of-12">
                                        ...
                                        <asp:Label ID="Label37" runat="server" Text="Student ID" Font-Bold="True" Font-Size="Large"></asp:Label>
                                    </div>

                                    <div class="col span-9-of-12">
                                <asp:Label ID="Label25" runat="server" Text='<%# Eval("student_id") %>'></asp:Label>
                                ...
                                <div>
                                    <div class="col span-3-of-12">
                                        ...
                                        <asp:Label ID="Label38" runat="server" Text="Roll no" Font-Bold="True" Font-Size="Large"></asp:Label>
                                    </div>

                                    <div class="col span-9-of-12">
                                        <asp:Label ID="Label26" runat="server" Text='<%# Eval("enrollment_no") %>'></asp:Label>
                                ...
                                <div>
                                    <div class="col span-3-of-12">
                                        ...
                                        <asp:Label ID="Label34" runat="server" Text="Stream" Font-Bold="True" Font-Size="Large"></asp:Label>
                                    </div>

                                    <div class="col span-9-of-12">
                                        <asp:Label ID="Label27" runat="server" Text='<%# Eval("stream") %>'></asp:Label>
                                ...
                                <div>
                                    <div class="col span-3-of-12">
                                        ...
                                        <asp:Label ID="Label39" runat="server" Text="Sub-stream" Font-Bold="True" Font-Size="Large"></asp:Label>
                                    </div>

                                    <div class="col span-9-of-12">
                                        <asp:Label ID="Label40" runat="server" Text='<%# Eval("sub_stream") %>'></asp:Label>
                                ...
                                <div>
                                    <div class="col span-3-of-12">
                                        ...
                                        <asp:Label ID="Label41" runat="server" Text="Semester" Font-Bold="True" Font-Size="Large"></asp:Label>
                                    </div>

                                    <div class="col span-9-of-12">
                                        <asp:Label ID="Label29" runat="server" Text='<%# Eval("semester") %>'></asp:Label>
                                ...
                                <div>
                                    <div class="col span-3-of-12">
                                        ...
                                        <asp:Label ID="Label35" runat="server" Text="Year" Font-Bold="True" Font-Size="Large"></asp:Label>
                                    </div>

                                    <div class="col span-9-of-12">
                                        <asp:Label ID="Label30" runat="server" Text='<%# Eval("year") %>'></asp:Label>

                                    </div>
                                </div>


                                <div class="grid-view-student-marks">
                                    <div class="col span-12-of-12">

                                        <asp:Label ID="Label24" runat="server" Text='<%# Eval("test_type") %>' Font-Bold="True" Font-Size="X-Large" CssClass="grid-view-label-student-marks"></asp:Label>
                                        <asp:Label ID="Label28" runat="server" Text='<%# Eval("subject") %>' Font-Size="X-Large" CssClass="grid-view-label-student-marks"></asp:Label>
                                        <asp:Label ID="Label22" runat="server" Text='<%# Eval("marks") %>' Font-Size="X-Large" CssClass="grid-view-label-student-marks"></asp:Label>
