<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="StudentPortalSystemWebsite.AdminModule.Default" %>
    ...
    <form id="form1" runat="server">
            ...
            <nav class="sticky login-js--wp-1">
                ...
                <div class="row">
                    ...
                    <ul class="main-nav js--main-nav">
                        ...
                        <li><a href="Default.aspx">Admin login</a></li>
                    </ul>
        ...
        <div class="login-page-width">
            ...
            <div class="col span-1-of-2  login-both-panel login-image-panel login-js--wp-2">
                ...
                <img src="resources/img/Staff.svg" alt="Admin Login Page" />
