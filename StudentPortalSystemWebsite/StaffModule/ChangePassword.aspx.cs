    ...
    public partial class ChangePassword : System.Web.UI.Page
    {
        ...
        bool checkOldPassword()
        {
            try
            {
                ...
                SqlCommand cmd = new SqlCommand("SELECT * FROM StaffDetails WHERE username = '" + username + "' AND password = '" + TextBox1.Text.Trim() + "';", con);
        ...
        void updateNewPassword()
        {
            try
            {
                ...
                SqlCommand cmd = new SqlCommand("UPDATE StaffDetails SET password = @password WHERE username = @username;", con);
